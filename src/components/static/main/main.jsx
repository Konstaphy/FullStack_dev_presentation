            ...
            <div className={classes.square}>
                ...
                <div className={classes.description_box}>
                    <p className={classes.description}>Фуллстек разработчики кто же они? Многие говорят, что быть
                        полноценным фуллстеком невозможно - пока освоишь новые технологии фронтенда, бекенд вырастет с
                        ещё большей, чем фронтенд скоростью, но так ли это? Существует множество мнений и каждый смотрит
